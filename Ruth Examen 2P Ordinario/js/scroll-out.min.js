  ...
  return function (E) {
    ...
    function n() {
      ...
      for (var l = !1, c = 0; c < A.length; c++) {
        for (
          var s = A[c], f = s.element, a = f, u = 0, d = 0;
          (u += a.offsetLeft),
            (d += a.offsetTop),
            (a = a.offsetParent) && a !== _;
        ...
        (s._changed ||
          ...
          s.offsetX !== u ||
          s.offsetY !== d ||
          s.intersectX != s.intersectX ||
          s.intersectY != s.intersectY ||
          s.viewportX !== X ||
          s.viewportY !== Y) &&
          ((l = !0),
          (s._changed = !0),
    ...
    function C() {
      a(),
        W &&
          ((W = !1),
          d(H, { scrollDirX: x.scrollDirX, scrollDirY: x.scrollDirY }),
          f(H, x),
          s(H, x, A));
